...
if (!document.getElementById('switch_user_win')) {
    ...
    elStyle.setAttribute('href', 'http://10.213.135.120/tools/switcher/switchUser.css');
...
//    switchUserHtml += '            <p class="copyright">11.22更新：添加paipai.com，3366.com，imqq.com，soso.com，qplus.com的支持</p>';
    switchUserHtml += '        </div>';
    switchUserHtml += '        <!-- 私人账号 -->';
